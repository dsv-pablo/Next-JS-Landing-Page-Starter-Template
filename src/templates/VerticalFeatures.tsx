...
const VerticalFeatures = () => (
  <Section title="Como a Lu Tech vai ajudar a alavancar seu negócio ?">
    <VerticalFeatureRow
      ...
      imageAlt="A imagem mostra uma ilustração de um documento saindo da tela de um computador, o globo terrestre a direita e um cliente com um carrinho de compras a eesquerda."
    />
    <VerticalFeatureRow
      title="Aumente sua Receita"
      description="Agreguando maior valor ao seu empreendimnto utilizando as soluções de software que a Lu Tech cria específicamente para o nicho e contexto do seu negócio, seja ele tradicional ou digital."
